(defun cmaxw/delete-out-of-date-bytecode (directory)
  ...
  (dolist (path-and-attributes (directory-files-and-attributes directory t))
    (let ((path       (car path-and-attributes))
      ...
      (cond ((string-prefix-p "." (file-name-nondirectory path))
            ...
            ((car attributes)
             (cmaxw/delete-out-of-date-bytecode path))
...
(cmaxw/delete-out-of-date-bytecode
 (expand-file-name "cmaxw" user-emacs-directory))
